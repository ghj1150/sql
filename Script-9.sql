...
-- '정보미디어학부'에 소속된 학생의 학번, 이름, 학과번호 조회
...
-- 학과별 평균키 보다 큰 학생의, 이름 학과번호 키를 조회
...
SELECT TO_CHAR(TO_DATE('2024-09-01', 'YYYY-MM-DD'), 'W') FROM DUAL; 
...
-- 학과 테이블에 DEPNO : 300, DNAME : 생명공학부를 추가
